...
SpaceClicker is a fast-paced idle/clicker game where you mine cosmic energy, upgrade ships, unlock planets, and build an automated space empire. Tap to earn faster, buy boosters, and climb infinite levels to become a galaxy tycoon.
...
Because the project uses React CDN + Babel, you can run it with any static web server.
